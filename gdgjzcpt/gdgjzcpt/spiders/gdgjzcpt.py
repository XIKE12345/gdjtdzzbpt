...
class GdgjzcptSpider(scrapy.Spider):
    name = 'gdgjzcpt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['gdgjzcpt.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(GdgjzcptSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # python3  -m scrapy crawl gdgjzcpt_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'https://zggdjt.dlzb.com/gongcheng/',
                ...
                'xpath_of_list': '//div[@class="m_right"]/ul/li',
            ...
            'page_2': {
                ...
                # list页面的base地址
                'base_url': 'https://zggdjt.dlzb.com/fuwu/',
            ...
            'page_3': {
                ...
                # list页面的base地址
                'base_url': 'https://zggdjt.dlzb.com/huowu/',
        ...
        for _k, _v in _source_info.items():
            ...
            for _page_num in range(1000000):
                ...
                _ext_param = {
                    ...
                    'notice_type_code': _v['notice_type_code'],
                    'tos_code': _v['tos_code'],
    ...
    def get_normal_next_page_url(page_index, base_url):
        ...
        if page_index == 0:
            ...
            return '{}page-{}.shtml'.format(base_url, page_index + 1)
...
class BaseItemCommonParser:
    ...
    #             'cid=21': '煤炭产能置换指标交易'
    #         }
    #         # http://gdgjzcpt.gov.cn/trade/noticeInfo/023061D4-B201-4FDD-A671-4DD22393EF9C?cid=21&type=0
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./a/text()').extract_first().replace('\\n', '').rstrip().lstrip()
