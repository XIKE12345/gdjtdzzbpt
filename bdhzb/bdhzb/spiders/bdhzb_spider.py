...
class BaseItemCommonParser:
    ...
    def get_common_raw_item(self, _id, detail_url, site, ext_param):
        ...
        self.item['notice_type_code'] = self.get_notice_type_code(detail_url)
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./span[@class="ewb-list-date"]/text()').extract_first()
    ...
    def get_notice_type_code(self, detail_url):
        try:
            _notice_type_code = {
                '003001001': '0101',
                '003001002': '0104',
