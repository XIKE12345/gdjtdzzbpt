...
class HbsggzyjyptSpider(scrapy.Spider):
    name = 'hbsggzyjypt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['ggzy.hebei.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(HbsggzyjyptSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl hbsggzyjypt_spider -a start_time="2019:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://www.hebpr.gov.cn/inteligentsearch/rest/inteligentSearch/getFullTextData',
                ...
                'xpath_of_list': ['result', 'records'],

                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': 'linkurl',
                ...
                'tos': '政府采购',
                'tos_code': '02',
                'source': '河北省全国公共资源交易平台',
                'site_name': '河北省全国公共资源交易平台',
                'notice_type': "采购/资审公告",
    ...
    def parse_list_page_common(self, response):
        ...
        if response.meta['param']['requests_type'] == "dict":
            ...
            for selector in _response_data:
                ...
                try:
                    _item_idx += 1
                    _detail_url = 'http://www.hebpr.gov.cn/hbggfwpt/' + str(
