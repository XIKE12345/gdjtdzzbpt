...
class ZghfwsscSpider(scrapy.Spider):
    name = 'zghfwssc_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['bs.gdggzy.org.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ZghfwsscSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl zghfwssc_spider -a start_time="2018:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://ebid.aecc-mall.com/front/ajax_getBidList.do',
                ...
                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': './div[@class="txt"]/h2/a/@href',
...
class BaseItemCommonParser:
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./div[@class="txt"]/h2/a/text()').extract_first()
