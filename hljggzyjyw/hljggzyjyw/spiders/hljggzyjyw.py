...
class HljggzyjywSpider(scrapy.Spider):
    name = 'hljggzyjyw_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['hljggzyjyw.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(HljggzyjywSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # python3  -m scrapy crawl hljggzyjyw_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://hljggzyjyw.gov.cn/trade/tradezfcg',
                ...
                'xpath_of_list': '//div[@class="right_box"]/ul/li',
...
class BaseItemCommonParser:
    ...
    def __get_notice_type__(self, detail_url):
        ...
        try:
            ...
            # http://hljggzyjyw.gov.cn/trade/noticeInfo/023061D4-B201-4FDD-A671-4DD22393EF9C?cid=21&type=0
