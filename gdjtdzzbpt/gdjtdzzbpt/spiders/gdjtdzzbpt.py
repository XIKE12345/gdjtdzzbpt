...
class GdjtdzzbptSpider(scrapy.Spider):
    name = 'gdjtdzzbpt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.cgdcbidding.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(GdjtdzzbptSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # python3  -m scrapy crawl gdjtdzzbpt_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'bids_search': {
                ...
                # list页面的base地址
                'base_url': 'http://www.cgdcbidding.com/',
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./a/span[@class="lb-date"]/text()').extract_first()
