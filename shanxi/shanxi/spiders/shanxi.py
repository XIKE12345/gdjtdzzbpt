...
class ShanxiSpider(scrapy.Spider):
    name = 'shanxi_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['prec.sxzwfw.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ShanxiSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl shanxi_spider -a start_time="2019:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://prec.sxzwfw.gov.cn/moreInfoController.do',
                ...
                'tos': '工程建设',
                'tos_code': '01',
                'source': '山西省全国公共资源交易平台',
                'site_name': '山西省全国公共资源交易平台',
                'notice_type': "交易信息",
            ...
            'page_6': {
                ...
                'tableName': 'gycqgq',
                'noticeInfo': 'getMoreNoticeInfo',
                # 'noticeInfo': 'getMoreResultNoticeInfo',
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_7': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
        ...
        for _k, _v in _source_info.items():
            ...
            for _page_num in range(100000):
                ...
                _ext_param = {
                    'tableName': _v['tableName'],
                    'noticeInfo': _v['noticeInfo'],
                ...
                if _v["method"] == "post":
                    ...
                    payload = '{"token":"","pn":' + str(
                        _page_num) + ',"rn":10,"sdt":"","edt":"","wd":"","inc_wd":"","exc_wd":"","fields":"title","cnum":"001","sort":"{\\"webdate\\":0}","ssort":"title","cl":200,"terminal":"","condition":[{"fieldName":"categorynum","equal":' + '"' + _type_info_item + '"' + ',"notEqual":null,"equalList":null,"notEqualList":null,"isLike":true,"likeType":2}],"time":null,"highlights":"title","statistics":null,"unionCondition":null,"accuracy":"","noParticiple":"0","searchRange":null,"isBusiness":"1"}'
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        ...
        return '{}?{}&{}'.format(base_url, ext_param['noticeInfo'], urlencode(_param, quote_via=quote_plus))
    ...
    def parse_list_page_common(self, response):
        ...
        if response.meta['param']['requests_type'] == "dict":
            ...
            for selector in _response_data:
                ...
                try:
                    _item_idx += 1
                    # http://prec.sxzwfw.gov.cn/moreInfoController.do?getNoticeDetail&url=/gcjs/gcjsNotice/form?id=&id=356aa08a8caa4d6f9a8b7658f023fa0a
                    _detail_url = 'http://prec.sxzwfw.gov.cn/moreInfoController.do?getNoticeDetail&url=' + \
                                  str(selector[response.meta['param']["xpath_of_detail_url"]]) + '&id=' + \
                                  str(selector[response.meta['param']['id']])
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _ret = self.selector['RECEIVETIME']
            _ret = _ret.replace('-', '.') + "00:00:00"
        except:
            _ret = ''
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector['PROJECTNAME']
        return _ret
