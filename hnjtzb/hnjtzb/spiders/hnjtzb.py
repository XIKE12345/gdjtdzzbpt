...
class HnjtzbSpider(scrapy.Spider):
    name = 'hnjtzb_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.cgdcbidding.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(HnjtzbSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # python3  -m scrapy crawl hnjtzb_spider -a start_time="now" -a end_time="now"
