...
class ZgdlzbwSpider(scrapy.Spider):
    name = 'zgdlzbw_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.zgdlzbw.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ZgdlzbwSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl zgdlzbw_spider -a start_time="2019:01:01" -a end_time="2020:03:02"
        ...
        _source_info = {
            ...
            'gc_search': {
                ...
                'xpath_of_list': '/html/body/div[6]/div[1]/div[3]/ul/li',
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        ...
        if page_index == 0:
            return '{}{}/'.format(base_url, ext_param['bid_type'])
        else:
            return '{}{}/{}-{}.html'.format(base_url, ext_param['bid_type'], ext_param['bid_type'],
                                            next_page)
...
class BaseItemCommonParser:
    ...
    def get_common_raw_item(self, _id, detail_url, site, ext_param):
        ...
        self.item['site_name'] = "中国电力招标网"
        self.item['area_code'] = '670000'
        self.item['content_code'] = '1'
        self.item['industry'] = self.__get_industry__(ext_param["notice_type"])
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./span[@class="gc_date"]/text()').extract_first()
    ...
    def __get_industry__(self, type):
        try:
            _notice_type = {
                'gongcheng': '工程',
                'huowu': '货物',
    ...
    def __get_title__(self):
        ...
        """
        _ret = ''
        print(self.selector.xpath('./a/text()'))
        _ret = self.selector.xpath('./a/text()').extract_first().rstrip().lstrip()
