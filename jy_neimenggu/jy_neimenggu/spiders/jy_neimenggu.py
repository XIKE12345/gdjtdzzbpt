...
class Jy_neimengguSpider(scrapy.Spider):
    name = 'jy_neimenggu_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.lntb.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(Jy_neimengguSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3  -m scrapy crawl jy_neimenggu_spider -a start_time="2019:01:01" -a end_time="2020:02:25"
        # python3  -m scrapy crawl jy_neimenggu_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                'name': '内蒙古招标投标公共服务平台--内蒙古招投标网',

                # list页面的base地址
                'base_url': 'http://www.nmgztb.com.cn/?',
                ...
                'xpath_of_list': '//div[@class="mycon_list"]/ul/li',
    ...
    def parse_list_page_common(self, response):
        ...
        for selector in response.xpath(response.meta['param']['xpath_of_list']):
            ...
            try:
                _item_idx += 1
                _detail_url = 'http://www.nmgztb.com.cn' + str(
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./span2[2]/text()').extract_first().replace('-', '.')
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./a/@title').extract_first()
