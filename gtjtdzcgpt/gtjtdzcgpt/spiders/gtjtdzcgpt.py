...
class GtjtdzcgptSpider(scrapy.Spider):
    name = 'gtjtdzcgpt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['eps.sdic.com.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(GtjtdzcgptSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # python3  -m scrapy crawl gtjtdzcgpt_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                'xpath_of_list': '//div[@class="lb-link"]/ul/li',
...
class BaseItemCommonParser:
    ...
    def get_common_raw_item(self, _id, detail_url, site, ext_param):
        ...
        # self.item['notice_type'] = self.__get_notice_type__(ext_param)
    ...
    #             'cid=21': '煤炭产能置换指标交易'
    #         }
    #         # http://gtjtdzcgpt.gov.cn/trade/noticeInfo/023061D4-B201-4FDD-A671-4DD22393EF9C?cid=21&type=0
