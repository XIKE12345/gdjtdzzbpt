...
class ZlptSpider(scrapy.Spider):
    name = 'zlpt_spider'                    # 需要修改成全局唯一的名字
    allowed_domains = ['eb.chinalco.com.cn']    # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ZlptSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl zlpt_spider -a start_time="2019:01:01" -a end_time="2019:03:02"
        ...
        _source_info = {
            ...
            'zbysbg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://eb.chinalco.com.cn/cms/channel/ywgg1',
            ...
            'zbhxrgs_search': {
                ...
                # list页面的base地址
                'base_url': 'http://eb.chinalco.com.cn/cms/channel/ywgg2',
            ...
            'zbjggs_search': {
                ...
                # list页面的base地址
                'base_url': 'http://eb.chinalco.com.cn/cms/channel/ywgg3',
        ...
        for _k, _v in _source_info.items():
            ...
            for _industry_code in _v['industry']:

                # 假定每个类别有不超过100000个页面
                for _page_num in range(1000000):

                    _base_url = _v['base_url'] + _industry_code
                    ...
                    _request_url = _v['get_next_page_url'](page_index=_page_num, base_url=_base_url)
                    ...
                    # 填充必要的参数
                    _param = _v.copy()
                    _param['industry'] = _v['industry'][_industry_code]
                    _request.meta['param'] = _param
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./a/em/text()').extract_first()
