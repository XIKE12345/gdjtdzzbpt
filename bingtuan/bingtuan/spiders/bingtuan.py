...
class BingtuanSpider(scrapy.Spider):
    name = 'bingtuan_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['ggzy.xjbt.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(BingtuanSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # python3  -m scrapy crawl bingtuan_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://ggzy.xjbt.gov.cn/TPFront/jyxx/',
                ...
                'source': '新疆建设兵团公共资源交易平台',
                'site_name': '新疆建设兵团公共资源交易平台',
                'area_code': '65',
                'content_code': '1',
                'bid_sort': '004001002',
                'bid_sort1': '004001',
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        ...
        if page_index == 0:
            # http://ggzy.xjbt.gov.cn/TPFront/jyxx/004001/004001003/
            return '{}{}/{}'.format(base_url, ext_param['bid_sort1'], ext_param['bid_sort'])
        else:
            return '{}{}/{}/?Paging={}'.format(base_url, ext_param['bid_sort1'],ext_param['bid_sort'], page_index + 1)
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('string(./td[3]/text())').extract_first().split('[')[1].split(']')[0]
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./td[2]/a/@title').extract_first().replace('\\n', '').rstrip().lstrip()
