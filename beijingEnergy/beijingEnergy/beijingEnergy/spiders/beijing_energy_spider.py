...
class BeijingEnergySpider(scrapy.Spider):
    name = 'beijingEnergy_spider'                    # 需要修改成全局唯一的名字
    allowed_domains = ['be-bidding.com']    # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(BeijingEnergySpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        _source_info = {
            ...
            'page_key': {
                ...
                # list页面的base地址
                'base_url': 'http://www.be-bidding.com/gjdq/jingneng/zhaobiao.jsp/',
