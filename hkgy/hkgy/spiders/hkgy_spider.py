...
class HkgySpider(scrapy.Spider):
    name = 'hkgy_spider'                    # 需要修改成全局唯一的名字
    allowed_domains = ['ebid.eavic.com']    # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(HkgySpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl hkgy_spider -a start_time="2019:01:01" -a end_time="2020:03:02"
        ...
        _source_info = {
            ...
            'zbgg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://ebid.eavic.com/cms/channel/ywgg1',
            ...
            'bggg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://ebid.eavic.com/cms/channel/ywgg2',
            ...
            'zbgs_search': {
                ...
                # list页面的base地址
                'base_url': 'http://ebid.eavic.com/cms/channel/ywgg3',
            ...
            'zbjggg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://ebid.eavic.com/cms/channel/ywgg4',
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./a/em[1]/text()').extract_first()
