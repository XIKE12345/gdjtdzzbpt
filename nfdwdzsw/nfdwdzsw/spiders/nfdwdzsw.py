...
class BdhzbSpider(scrapy.Spider):
    name = 'nfdwdzsw_spider'                    # 需要修改成全局唯一的名字
    ...
    def start_requests(self):
        ...
        # python3  -m scrapy crawl nfdwdzsw_spider -a start_time="now" -a end_time="now"
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./span[@class="Right Gray"]/text()').extract_first()
