...
class ZgjjzbcgglxxxtSpider(scrapy.Spider):
    name = 'zgjjzbcgglxxxt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['sup.ccccltd.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ZgjjzbcgglxxxtSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl zgjjzbcgglxxxt_spider -a start_time="2018:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://sup.ccccltd.cn/ecp/web/AnnounceAction.do?cmd=goListAnnounce',
                ...
                # 'xpath_of_list': '//ul[@id="listId"]//li',
                'xpath_of_list': '//li',

                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': './span[@class="dotspan"]/a/@href',
        ...
        for _k, _v in _source_info.items():
            ...
            for _page_num in range(100000):
                ...
                if _v["method"] == "post":
                    _payload = {
                        'type': "0",
                        'VENUS_PAGE_NO_KEY': str(_page_num + 1),
                        'VENUS_PAGE_COUNT_KEY': "94",
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector.xpath('.//span/text()').extract_first()
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./span[@class="dotspan"]/a/font/text()').extract_first()

        return _ret

    def __get_notice_type__(self):
        _ret = self.selector.xpath('./span[@class="dotspan"]/a/font/text()').extract_first().strip('】')[0:]
        return _ret
