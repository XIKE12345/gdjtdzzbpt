...
class QdgxjtSpider(scrapy.Spider):
    name = 'qdgxjt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['eps.qdgxjt.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(QdgxjtSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl qdgxjt_spider -a start_time="2019:01:01" -a end_time="2020:03:02"
        ...
        _source_info = {
            ...
            'zbgg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://eps.qdgxjt.com/cms/channel/xmgg1qb/index.htm',
            ...
            'zbjggg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://eps.qdgxjt.com/cms/channel/xmgg2qb/index.htm',
            ...
            'cggg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://eps.qdgxjt.com/cms/channel/xmgg3qb/index.htm',
                ...
                # 连续遇到[stop_dup_item_num]个重复条目后，停止本次抓取
                # 提示：在程序运行初始阶段，此值可以设的较大，以便爬取所有的历史记录
                'stop_dup_item_num': 500000 if self.crawl_mode == CrawlMode.HISTORY else 10,
            ...
            'cgjggg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://eps.qdgxjt.com/cms/channel/xmgg4qb/index.htm',
    ...
    def get_normal_next_page_url(page_index, base_url):
        return '{}?pageNo={}'.format(base_url, page_index + 1)
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            notice_time = self.selector.xpath('./a[1]/em/text()').extract_first().replace('-', '.').rstrip().lstrip()
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./a[1]/span[1]/text()').extract_first()
        # .replace('\\n', '').rstrip().lstrip()
