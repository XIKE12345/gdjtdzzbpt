...
class HbggzyfwptSpider(scrapy.Spider):
    name = 'hbggzyfwpt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.hbggzyfwpt.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(HbggzyfwptSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl hbggzyfwpt_spider -a start_time="2018:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'https://www.hbggzyfwpt.cn/jyxx/jsgcXmxx',
            ...
            'page_7': {
                ...
                # list页面的base地址
                'base_url': 'https://www.hbggzyfwpt.cn/jyxx/zfcg/cggg',
            ...
            'page_19': {
                ...
                # list页面的base地址
                'base_url': 'https://www.hbggzyfwpt.cn/jyxx/cqjy/crgg',
            ...
            'page_21': {
                ...
                # list页面的base地址
                'base_url': 'https://www.hbggzyfwpt.cn/jyxx/kyqcr/zpgCrgg',
            ...
            for _page_num in range(100000):
                ...
                if _v["method"] == "post":
                    _payload = {
                        ...
                        'projectName': "",
                        'publishTimeType': "3",
                        'publishTimeStart': str(self.start_time),
                        'publishTimeEnd': str(self.end_time)
                    }
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector.xpath('string(./td[2])').extract_first().rstrip().lstrip().split('\r\n')[0]
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./td[1]/a//@title').extract_first().replace('\\n', '').rstrip().lstrip()
