...
class SdnyjtdzzbwSpider(scrapy.Spider):
    name = 'sdnyjtdzzbw_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['snzb.minegoods.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(SdnyjtdzzbwSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl sdnyjtdzzbw_spider -a start_time="2019:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'gkzb_gc_search': {
                ...
                # list页面的base地址
                'base_url': 'http://snzb.minegoods.com/sdnycms/category/bulletinList.html',
                ...
                'xpath_of_list': '/html/body/div[3]/div[2]/div[2]/ul/li',
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        ...
        if page_index == 0:
            return '{}?{}'.format(base_url,
                                  "searchDate=" + start_date + "&dates=300&word=&categoryId=" + ext_param[
                                      'notice_type'] + "&tabName=招标公告&industryName=" + ext_param['source'] + "&status=")
        else:
            return '{}?{}{}'.format(base_url,
                                    "searchDate=" + start_date + "&dates=300&word=&categoryId=" + ext_param[
                                        'notice_type'] + "&tabName=招标公告&industryName=" + ext_param[
                                        'source'] + "&status=&page=",
                                    next_page)
...
class BaseItemCommonParser:
    ...
    def get_common_raw_item(self, _id, detail_url, site, ext_param):
        ...
        self.item['site_name'] = "山东能源集团电子招标投标交易平台"
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./a/div/div/text()').extract_first()
    ...
    def __get_title__(self):
        ...
        """
        _ret = ''
        _ret = self.selector.xpath('./a/h1/text()').extract_first().rstrip().lstrip()
