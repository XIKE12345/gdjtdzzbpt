...
class ZtlbswwSpider(scrapy.Spider):
    name = 'ztlbsww_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.crecgec.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ZtlbswwSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # python3  -m scrapy crawl ztlbsww_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'zbgg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://www.crecgec.com/forum.php',
                ...
                'xpath_of_list': '//div[@class="listContent"]/ul//li',
            ...
            'jzxtp_search': {
                ...
                # list页面中，获得条目列表的xpath
                # 'xpath_of_list': '//ul[@class="nowlook"]//li',

                'xpath_of_list': '//div[@class="listContent"]/ul[@class="nowlook"]/form/li',
                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': './a/@href',
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        if page_index == 0:
            ...
            _param = {
                ...
                'fid': 2,
                'filter': 'sortid',
                'sortid': ext_param['bid_sort'],
            }
            # http://www.crecgec.com/forum.php
            # http://www.crecgec.com/forum.php?mod=forumdisplay&fid=2&filter=sortid&sortid=12
            ...
            # http://www.crecgec.com/forum.php?mod=forumdisplay&fid=2&sortid=12&filter=sortid&sortid=12&page=2
            return '{}?{}'.format(base_url, urlencode(_param, quote_via=quote_plus))
