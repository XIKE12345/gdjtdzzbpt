...
class ZgwkjtSpider(scrapy.Spider):
    name = 'zgwkjt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['ec.mcc.com.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ZgwkjtSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl zgwkjt_spider -a start_time="2018:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://ec.mcc.com.cn/b2b/web/two/indexinfoAction.do?actionType=showMoreCgxx&xxposition=cgxx',
                ...
                'xpath_of_list': '//table[@class="datatlb"]//tr',

                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': './td[@class="txtLeft"]/a/@onclick',
            ...
            'page_2': {
                ...
                # list页面的base地址
                'base_url': 'http://ec.mcc.com.cn/b2b/web/two/indexinfoAction.do?actionType=showMoreZbs&xxposition=zbgg',
            ...
            'page_3': {
                ...
                # list页面的base地址
                'base_url': 'http://ec.mcc.com.cn/b2b/web/two/indexinfoAction.do?actionType=showMoreClarifypub&xxposition=cqgg',
            ...
            'page_4': {
                ...
                # list页面的base地址
                'base_url': 'http://ec.mcc.com.cn/b2b/web/two/indexinfoAction.do?',
        ...
        for _k, _v in _source_info.items():
            ...
            for _page_num in range(100000):
                ...
                if _v["method"] == "post":
                    _payload = {
                        'actionType': _v['actionType'],
                        'xxposition': _v['xxposition'],
                        'zbmc': "",
                        'sbsj1': "",
                        'currpage': str(_page_num + 1)
                    }
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector.xpath('./td[2]/text()').extract_first()
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./td[@class="txtLeft"]/a/@title').extract_first()
