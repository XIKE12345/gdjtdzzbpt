...
class TmzbSpider(scrapy.Spider):
    name = 'tmzb_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['dzzb.dtcoalmine.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(TmzbSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl tmzb_spider -a start_time="2019:01:01" -a end_time="2020:03:02"
        ...
        _source_info = {
            ...
            'yfbz_search': {
                ...
                # list页面的base地址
                'base_url': 'https://dzzb.dtcoalmine.com/cms/channel/1ywgg4qb/',
            ...
            'fyfbz_search': {
                ...
                # list页面的base地址
                'base_url': 'https://dzzb.dtcoalmine.com/cms/channel/1ywgg3qb/',
            ...
            'fzbcg_search': {
                ...
                # list页面的base地址
                # https://dzzb.dtcoalmine.com/cms/channel/1ywgg1qb/index.htm
                'base_url': 'https://dzzb.dtcoalmine.com/cms/channel/1ywgg1qb/',
            ...
            'page_4': {
                ...
                # list页面的base地址
                'base_url': 'https://dzzb.dtcoalmine.com/cms/channel/1ywgg5qb/',
            ...
            'page_5': {
                ...
                # list页面的base地址
                'base_url': 'https://dzzb.dtcoalmine.com/cms/channel/1ywgg6qb/',
        ...
        for _k, _v in _source_info.items():
            ...
            for _notice_code in _v['notice_type']:
                # 假定每个类别有不超过100000个页面
                for _page_num in range(1000000):

                    # _base_url = _v['base_url'] + _notice_code + 'qb'
    ...
    def get_normal_next_page_url(page_index, base_url):
        if page_index == 0:
            return '{}/index.htm'.format(base_url)
        else:
            # https://dzzb.dtcoalmine.com/cms/channel/1ywgg6qb/index.htm?pageNo=2
            return '{}/index.htm?pageNo={}'.format(base_url, page_index + 1)
...
class BaseItemCommonParser:
    ...
    def get_common_raw_item(self, _id, detail_url, site, ext_param):
        ...
        # self.item['tos'] = self.__get_tos__(detail_url, ext_param)
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('.//em/text()').extract_first()
    ...
    # def __get_notice_type__(self, detail_url, ext_param):
    #     try:
    #         _url_list = detail_url.lstrip('http://').split('/')
    #         _notice_key = _url_list[3][5]
    #         _ret = ext_param['notice_type'][_notice_key]
    #     except:
    #         _ret = ''
    ...
    def __get_tos__(self, detail_url, ext_param):
        try:
            _url_list = detail_url.lstrip('http://').split('/')
            _tos_key = _url_list[3][-2:]
            _ret = ext_param['tos'][_tos_key]
        except:
            _ret = ''
            logging.exception('[{}] get_tos failed'.format(self.item['_id']))
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./a[1]/@title').extract_first().replace('\\n', '').rstrip().lstrip()
