...
class ZgbqdzztbjyptSpider(scrapy.Spider):
    name = 'zgbqdzztbjypt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['bid.norincogroup-ebuy.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ZgbqdzztbjyptSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl zgbqdzztbjypt_spider -a start_time="2018:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'https://bid.norincogroup-ebuy.com/retrieve.do',
                ...
                'xpath_of_list': '//div[@class="zbztbn_bgbox"]/div[@class="item"]',

                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': './/div[@class="ellipsis xminfo fl clearfix"]//a/@href',
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector.xpath(
                'string(.//div[@class="xmtime fr clearfix"]/span/text())').extract_first().split(":")[1]
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath(
            './/div[@class="ellipsis xminfo fl clearfix"]//a[@class="sldivTitle"]/@title').extract_first().split("'")[0]
