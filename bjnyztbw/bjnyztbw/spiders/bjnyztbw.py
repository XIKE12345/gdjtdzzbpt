...
class BjnyztbwSpider(scrapy.Spider):
    name = 'bjnyztbw_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['hbe-bidding.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(BjnyztbwSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl bjnyztbw_spider -a start_time="2018:01:01" -a end_time="2019:01:02"
        # python3 -m scrapy crawl bjnyztbw_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://www.be-bidding.com/gjdq/jingneng/jinnengdata.do?',
                ...
                'xpath_of_list': '//div[@class="txt"]/ul/li',
