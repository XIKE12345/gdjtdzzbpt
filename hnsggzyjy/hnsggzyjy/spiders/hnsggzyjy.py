...
class HnsggzyjySpider(scrapy.Spider):
    name = 'hnsggzyjy_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['bidding.csg.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(HnsggzyjySpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # py -3 -m scrapy crawl hnsggzyjy_spider -a start_time="2019:01:01" -a end_time="2019:01:02"
        # python3  -m scrapy crawl hnsggzyjy_spider -a start_time="now" -a end_time="now"
        ...
        _source_info = {
            ...
            'gcjs_search': {
                ...
                # list页面的base地址
                'base_url': 'https://www.hnsggzy.com/',
                ...
                'xpath_of_list': '//div[@class="article-content"]/ul[@class="article-list2"]/li',

                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': './div[@class="article-list3-t"]/a/@href',
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        ...
        if page_index == 0:
            return '{}{}/index.jhtml'.format(base_url, ext_param['bid_sort'])
        else:
            return '{}{}/index_{}.jhtml'.format(base_url, ext_param['bid_sort'], page_index + 1)
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath(
                './div[@class="article-list3-t"]/div[@class="list-times"]/text()').extract_first()
