...
class XinjiangSpider(scrapy.Spider):
    name = 'xinjiang_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['zwfw.xinjiang.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(XinjiangSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl xinjiang_spider -a start_time="2019:01:01" -a end_time="2019:01:02"
            ...
            for _page_num in range(100000):
                ...
                if _v["method"] == "post":
                    ...
                    payload = '{"token":"","pn":' + '"' + str(
                        _page_num * 10) + '"' + ',"rn":10,"sdt":"","edt":"","wd":"","inc_wd":"","exc_wd":"","fields":"title,projectnum","cnum":"005","sort":"{\\"infodate\\":\\"0\\"}","ssort":"title","cl":200,"terminal":"","condition":[{"fieldName":"categorynum","isLike":true,"likeType":2,"equal":' + '"' + _type_info_item + '"' + '}],"time":null,"highlights":"title","statistics":null,"unionCondition":null,"accuracy":"100","noParticiple":"0","searchRange":null,"isBusiness":1}'
    ...
    def parse_list_page_common(self, response):
        ...
        if response.meta['param']['requests_type'] == "dict":
            ...
            for selector in _response_data:
                ...
                try:
                    _item_idx += 1
                    _detail_url = 'http://zwfw.xinjiang.gov.cn/xinjiangggzy/' + str(
