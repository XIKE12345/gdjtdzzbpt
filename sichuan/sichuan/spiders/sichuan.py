...
class SichuanSpider(scrapy.Spider):
    name = 'sichuan_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['ggzyjy.sc.gov.cn']  # 需要修改成爬取网站的域名
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl sichuan_spider -a start_time="2019:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://ggzyjy.sc.gov.cn/inteligentsearch/rest/inteligentSearch/getFullTextData',
                ...
                'tos': '工程建设',
                'tos_code': '01',
                'source': '四川省全国公共资源交易平台',
                'site_name': '四川省全国公共资源交易平台',
                'notice_type': "招标公告",
            ...
            for _page_num in range(100000):
                ...
                if _v["method"] == "post":
                    ...
                    payload = '{"token":"","pn":' + str(
                        _page_num) + ',"rn":12,"sdt":"","edt":"","wd":"","inc_wd":"","exc_wd":"","fields":"title","cnum":"","sort":"{\\"webdate\\":0}","ssort":"title","cl":500,"terminal":"","condition":[{"fieldName":"categorynum","equal":' + '"' + _type_info_item + '"' + ',"notEqual":null,"equalList":null,"notEqualList":null,"isLike":true,"likeType":2}],"time":[{"fieldName":"webdate","startTime": "1990-01-01 00:00:00","endTime":"2099-12-29 23:59:59"}],"highlights":"","statistics":null,"unionCondition":null,"accuracy":"","noParticiple":"0","searchRange":null,"isBusiness":"1"}'
        ...
        if response.meta['param']['requests_type'] == "dict":
            ...
            for selector in _response_data:
                ...
                try:
                    ...
                    _detail_url = 'http://ggzyjy.sc.gov.cn/' + str(
