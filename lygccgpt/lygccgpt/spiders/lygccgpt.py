...
class LygccgptSpider(scrapy.Spider):
    name = 'lygccgpt_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['lygccgpt.gdlygc.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(LygccgptSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl lygccgpt_spider -a start_time="2019:01:01" -a end_time="2020:03:02"
        ...
        _source_info = {
            ...
            'zbgg_gc_search': {
                ...
                # list页面的base地址
                'base_url': 'http://lygccgpt.gdlygc.cn/cms/channel/',
                ...
                'xpath_of_list': '//*[@id="main"]/div[2]/div/div[1]/div/div[2]/div/div/ul/li',
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        start_date = ext_param['start_time'].replace(":", "-")
        next_page = page_index + 1
        if page_index == 0:
            return '{}{}/index.htm'.format(base_url, ext_param['notice_type'] + ext_param['source_code'])
        else:
            return '{}{}/index.htm?pageNo={}'.format(base_url, ext_param['notice_type'] + ext_param['source_code'],
                                                     next_page)
...
class BaseItemCommonParser:
    ...
    def get_common_raw_item(self, _id, detail_url, site, ext_param):
        ...
        self.item['notice_type'] = self.__get_notice_type__(ext_param["notice_type"])
        ...
        self.item['site_name'] = "龙源工程采购招标平台"
        self.item['area_code'] = '670000'
        self.item['notice_type_code'] = self.__get_notice_type_code__(ext_param["notice_type"])
        self.item['content_code'] = '1'
        self.item['tos_code'] = '01'
        self.item['industry'] = ext_param["source"]
        return self.item

    def __get_notice_type_code__(self, type):
        try:
            _notice_type = {
                'cggg1': '0101',
                'cggg2': '0101',
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('./a/span[@class="bidDate"]/text()').extract_first()
    ...
    def __get_notice_type__(self, type):
        try:
            _notice_type = {
                'cggg1': '招标公告',
                'cggg2': '非招标公告',
    ...
    def __get_title__(self):
        ...
        """
        _ret = ''
        _ret = self.selector.xpath('./a/span[@class="bidLink"]/text()').extract()[1].rstrip().lstrip()
