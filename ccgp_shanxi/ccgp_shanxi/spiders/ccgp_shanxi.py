...
class Ccgp_shanxi_Spider(scrapy.Spider):
    name = 'ccgp_shanxi_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.ccgp-shaanxi.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(Ccgp_shanxi_Spider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # nohup python3 -m scrapy crawl ccgp_shanxi_spider -a start_time="2019:01:01" -a end_time="2020:02:25" > /dev/null&
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://www.ccgp-shaanxi.gov.cn/notice/noticeaframe.do?isgovertment=&noticetype=3',
                ...
                'xpath_of_list': '//table[@class="table table-no tab-striped tab-hover"]/tbody/tr',
            ...
            'page_2': {
                ...
                # list页面的base地址
                'base_url': 'http://www.ccgp-shaanxi.gov.cn/notice/noticeaframe.do?isgovertment=&noticetype=5',
            ...
            'page_3': {
                ...
                # list页面的base地址
                'base_url': 'http://www.ccgp-shaanxi.gov.cn/notice/noticeaframe.do?isgovertment=&noticetype=4',
            ...
            'page_4': {
                ...
                # list页面的base地址
                'base_url': 'http://www.ccgp-shaanxi.gov.cn/notice/noticeaframe.do?isgovertment=&noticetype=6',
            ...
            'page_4': {
                ...
                # list页面的base地址
                'base_url': 'http://www.ccgp-shaanxi.gov.cn/notice/noticeaframe.do?isgovertment=&noticetype=99',
            ...
            'page_5': {
                ...
                # list页面的base地址
                'base_url': 'http://www.ccgp-shaanxi.gov.cn/notice/noticeaframe.do?isgovertment=&noticetype=1',
    ...
    def parse_list_page_common(self, response):
        ...
        if response.meta['param']['requests_type'] == "dict":
            ...
            for selector in response.xpath(response.meta['param']['xpath_of_list']):
                ...
                try:
                    _item_idx += 1
                    _detail_url = selector.xpath(response.meta['param']['xpath_of_detail_url']).extract_first()
                    _unq_id = JyScrapyUtil.get_unique_id(_detail_url)
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector.xpath('./td[4]/text()').extract_first()
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./td[3]/a/text()').extract_first().replace('\\n', '').strip()
