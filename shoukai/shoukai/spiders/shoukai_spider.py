...
class ShoukaiSpider(scrapy.Spider):
    name = 'shoukai_spider'                    # 需要修改成全局唯一的名字
    allowed_domains = ['http://ebidding.shoukaigufen.com.cn']    # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(ShoukaiSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3  -m scrapy crawl shoukai_spider -a start_time="2019:01:01" -a end_time="2020:03:02"
        ...
        _source_info = {
            ...
            'zbgg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://ebidding.shoukaigufen.com.cn/skcms/category/bulletinList.html?',
            ...
            'bggg_search': {
                ...
                # list页面的base地址
                'base_url': 'http://ebidding.shoukaigufen.com.cn/skcms/category/resultBulletinList.html?',
        ...
        for _k, _v in _source_info.items():
            ...
            for _industry in _v['industry']:
                ...
                for _page_num in range(1000000):
                    ...
                    _request_url = _v['get_next_page_url'](page_index=_page_num + 1, base_url=_v['base_url'], ext_param=_ext_param)
                    ...
                    # 填充必要的参数
                    _request.meta['param'] = _v.copy()
                    _request.meta['param']['industry'] = _industry
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        _param = {
            ...
            'tabName': ext_param['tos'],
            'industryName': ext_param['industry'],
            'status': '',
            'page': page_index
        }
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        ...
        try:
            ...
            _notice_time = self.selector.xpath('string(./a/div[last()])').extract_first()
            if _notice_time:
                _ret = _notice_time.strip().replace('\t', '').replace('\r', '').replace('\n', '-').replace('/', '-') + ' 00:00:00'
        except:
            _ret = ''
