...
class Ccgp_guizhou_Spider(scrapy.Spider):
    name = 'ccgp_guizhou_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.ccgp-guizhou.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(Ccgp_guizhou_Spider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl ccgp_guizhou_spider -a start_time="2020:01:01" -a end_time="2020:02:25"
