...
class AngangSpider(scrapy.Spider):
    name = 'angang_spider'                    # 需要修改成全局唯一的名字

    allowed_domains = ['bid.ansteelscm.com']    # 需要修改成爬取网站的域名(鞍山)

    def __init__(self, *args, **kwargs):
        super(AngangSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # py -3 -m scrapy crawl angang_spider -a start_time="2019:01:01" -a end_time="2019:01:02"
        # py -3 -m scrapy crawl angang_spider -a start_time="now" -a end_time="now"
        # py -3 -m scrapy crawl angang_spider -a start_time="now" -a end_time="now" -a start_page="700" -a end_page="1000" -a stop_item="10000"
        ...
        _source_info = {
            ...
            'page_key': {
                ...
                # list页面的base地址
                'base_url': 'https://bid.ansteelscm.com/cpu-angang-bid-fe/portalcas.html#/pages/supply_workbench/list',
...
class BaseItemCommonParser:
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./a[1]/text()').extract_first().replace('\\n', '').rstrip().lstrip()
