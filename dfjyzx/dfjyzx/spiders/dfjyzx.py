...
class DfjyzxSpider(scrapy.Spider):
    name = 'dfjyzx_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.dongfengtc.com']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(DfjyzxSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl dfjyzx_spider -a start_time="2018:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'https://www.dongfengtc.com/gg/ggList',
                ...
                'xpath_of_list': '//div[@class="item-list"]//tr',
            ...
            'page_2': {
                ...
                # list页面的base地址
                'base_url': 'https://www.dongfengtc.com/gg/zgysList',
            ...
            'page_3': {
                ...
                # list页面的base地址
                'base_url': 'https://www.dongfengtc.com/gg/bgggList',
            ...
            'page_4': {
                ...
                # list页面的base地址
                'base_url': 'https://www.dongfengtc.com/gg/zbkzjList',
            ...
            'page_5': {
                ...
                # list页面的base地址
                'base_url': 'https://www.dongfengtc.com/gg/zgscList',
            ...
            'page_6': {
                ...
                # list页面的base地址
                'base_url': 'https://www.dongfengtc.com/gg/zbhxrList',
            ...
            'page_7': {
                ...
                # list页面的base地址
                'base_url': 'https://www.dongfengtc.com/gg/zbjgList',
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector.xpath('./td[5]/text()').extract_first()
            _ret = _notice_time.replace(' ', '').replace('-', '.') + ' 00:00:00'
        except:
            _ret = ''
