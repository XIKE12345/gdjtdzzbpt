...
class EnergychinaSpider(scrapy.Spider):
    name = 'energychina_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['ec.ceec.net.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(EnergychinaSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl energychina_spider -a start_time="2018:01:01" -a end_time="2019:01:02"
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                'xpath_of_list': '//div[@class="real_news_show"]/div[@class="list01"]',

                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': './span[2]/a/@href',
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        ...
        return '{}{}&bigType={}&smallType=aAB3AA==&PageD={}'.format(base_url, ext_param['InfoLevel'],
                                                                    ext_param['bigType'], page_index + 1)
    ...
    def parse_list_page_common(self, response):
        ...
        if response.meta['param']['requests_type'] == "dict":
            ...
            for selector in response.xpath(response.meta['param']['xpath_of_list']):
                ...
                try:
                    _item_idx += 1
                    _detail_url = 'http://ec.ceec.net.cn/HomeInfo/' + selector.xpath(
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector.xpath('./span[@class="title02"]/text()').extract_first()
